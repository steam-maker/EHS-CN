...
* Brief introduction in English: In making the second version of the FLEX machine, I took Iron's ideas into concern, replacing the compiler by a direct interpreter.
* 段落大意：第二代FLEX的开发借用了艾恩斯的想法，用解释器取代语法定向编译器。
